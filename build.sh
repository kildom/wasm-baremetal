...
function llvm {
	...
	[ -e build.ninja ] || cmake -G Ninja \
		...
		# TODO: -DDEFAULT_SYSROOT=wasm32-unknown-unknown probably will assign default [installdir]/wasm32-unknown-unknown
...
function compiler-rt {
	...
	[ -e build.ninja ] || cmake -G Ninja \
		-DCMAKE_SYSROOT=$INSTALL_DIR/opt/wasm-baremetal/share/wasm-bm-sysroot \
